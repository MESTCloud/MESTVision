		...
		c = function() {
			$("body").on("click", ".sidebar-toggler", function(e) {
				...
				var a = $("body"),
					t = $(".page-sidebar"),
					i = $(".page-sidebar-menu");
					i.find("ul").removeAttr("style");
				$(".sidebar-search", t).removeClass("open"), a.hasClass("page-sidebar-closed") ? ( a.removeClass("page-sidebar-closed"), i.removeClass("page-sidebar-menu-closed"), Cookies && Cookies.set("sidebar_closed", "0"), i.css("overflow-y", "auto"), i.css("height", pFrameHeight)) : (a.addClass("page-sidebar-closed"), i.addClass("page-sidebar-menu-closed"), a.hasClass("page-sidebar-fixed") && i.trigger("mouseleave"), Cookies && Cookies.set("sidebar_closed", "1"), i.removeAttr("style")), $(window).trigger("resize")
			})
		},
		h = function() {
