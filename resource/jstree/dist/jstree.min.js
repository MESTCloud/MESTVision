							...
							setTimeout(function () { 
								...
								$(this).prop("data-toggle", "modal");
										$('#my_Modal_tree_Add').modal('show');
											...
											var imge="fa fa-folder icon-state-warning";
											var jsStr = "AddModule {\"parent\":\"" + obj.id + "\",\"name\":\"" + $("#input_treeName").val().trim() + "\",\"image\":\"" + imge+ "\",\"url\":\"" + $("#input_treeAddress").val().trim() + "\"}";
											 ...
											 //console.log(new_node);
				                              ...
				                              new_node.icon=$("#inputTree_Add").val().trim();
				                               new_node.url=$("#input_treeAddress_update").val().trim();
				                             // obj.url="sss";
											  inst.edit(new_node); 
								        ...
								        $("#input_treeName_update").val(obj.text);
								         //$("#inputTree_Update").text(obj.icon);
								          $("#input_treeAddress_update").val(obj.url);
											...
											var jsStr = "UpdateModule {\"id\":\"" + obj.id + "\",\"parent\":\"" + obj.parent + "\",\"name\":\"" + $("#input_treeName_update").val().trim() + "\",\"image\":\"" + imge+ "\",\"url\":\"" + $("#input_treeAddress_update").val().trim() + "\"}";
                                            
											  send(jsStr);
											  obj.text=$("#input_treeName_update").val().trim();
											  obj.icon=$("#inputTree_Update").val().trim();
											  inst.edit(obj)
